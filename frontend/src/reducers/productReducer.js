  ...
  switch (action.type) {
    case ALL_WISHLIST_PRODUCTS_REQUEST:
      return {
        ...state,
        loading: true,
        error: null // Reset error for a fresh request
      };
    ...
    case ALL_WISHLIST_PRODUCTS_SUCCESS:
      return {
        ...state,
        loading: false,
        wishlist: action.payload // Update state with fetched data
      };

    case ADD_PRODUCT_TO_WISHLIST_SUCCESS:
      const updatedWishlist = [...state.wishlist, action.payload];
      localStorage.setItem('wishlist', JSON.stringify(updatedWishlist));
      console.log('Wishlist after ADD:', updatedWishlist); // Log after addition
      return {
        ...state,
        loading: false,
