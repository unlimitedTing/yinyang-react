...
export const getAllPrices = () => async dispatch => {
  try {
    ...
    const { data } = await api.get('/api/v1/prices/all');
...
export const getSubscriptionDetails = id => async dispatch => {
  try {
    ...
    const { data } = await api.get(`/api/v1/admin/subscription/${id}`);
...
export const deleteSubscription = id => async dispatch => {
  try {
    ...
    const { data } = await api.delete(`/api/v1/admin/subscription/${id}`);
...
export const cancelSubscription = id => async dispatch => {
  try {
    ...
    const { data } = await api.put(`/api/v1/admin/subscription/${id}/cancel`);
